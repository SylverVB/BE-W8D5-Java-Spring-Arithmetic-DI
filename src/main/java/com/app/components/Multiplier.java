...
/**
 * For the purpose of this application, the Multiplier class depends on the functionality of the Adder class,
 * making Adder a dependency of Multiplier.
 *
...
public class Multiplier {
    /**
     * Adding an annotation over this Adder field to achieve field injection.

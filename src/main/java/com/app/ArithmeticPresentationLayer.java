...
import com.app.components.Adder;
import com.app.components.Multiplier;
import com.app.components.Squarer;
...
/**
 * To show off how dependency injection works, this class uses the Adder, Multiplier, and Squarer classes to
 * perform mathematical operations and return the results as strings.
 *
 ...
 *
 * The task is to add the @Autowired annotation to achieve dependency injection in 3 different ways (constructor, setter, and field)
 */
@ComponentScan(basePackages = "com.app.components")
@Component
public class ArithmeticPresentationLayer {
    ...
    public static void main(String[] args) {
        ...
        // Print out all the bean names to see if your beans are being created
        ...
        // (Example: Print result of operations to test output)
        System.out.println(app.addConvertToString(3, 4));
        System.out.println(app.multiplyConvertToString(3, 4));
